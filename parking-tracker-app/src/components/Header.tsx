...
export default function Header() {
  ...
  return (
    <div className="bg-white flex flex-col md:flex-row items-center justify-center py-3 md:py-5 top-0 z-50 relative">
      <div className="flex flex-row items-center px-3 md:px-5 mb-2 md:mb-0 md:absolute start-0">
        <UserButton />
      ...
      <div className="flex flex-row items-center px-3 md:px-5 md:absolute end-0">
